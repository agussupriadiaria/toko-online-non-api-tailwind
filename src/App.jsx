          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-8 justify-items-center">
            ...
            {filteredProducts.map((product) => (
              <div
                ...
                className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden w-full max-w-[340px] transition-all hover:scale-105 hover:shadow-2xl" // Styling card
              >
                {/* Gambar produk */}
                <img
